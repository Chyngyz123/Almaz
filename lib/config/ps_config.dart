...
class PsConfig {
  ...
  ///
  static const String ps_api_key = 'beishenbaevumar';
  ...
  static final Language defaultLanguage =
      Language(languageCode: 'ru', countryCode: 'RU', name: 'Руский');
  ...
  ///
  static const String tmpImageFolderName = 'Almaz';
